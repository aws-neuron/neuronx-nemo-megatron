...
from apex.transformer.pipeline_parallel.utils import get_kth_microbatch, get_batch_iterator
...
def forward_backward_pipelining_without_interleaving(
    ...
    **kwargs,
    ...
    data_iter = iter(get_batch_iterator(batch))
    ###################################################################################################################
