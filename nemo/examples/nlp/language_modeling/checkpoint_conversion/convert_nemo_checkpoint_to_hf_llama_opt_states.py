...
def convert_checkpoint(config_file,
        ...
        for k in tp_models[0].keys():  # e.g., k: 0, 1, ..., 85 for pp=0 and 0, 1, ..., 84 for pp>0
            ...
            if "query_key_value" in key:
                ...
                if num_query_groups is not None and num_query_groups > 0 and num_query_groups != num_attention_heads:
                    ...
                    # - GPU GQA (GPU training stack or AmazonNeMo) or
    ...
    print(f"saved HF style optimizer states in {path}")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="VPP value if set",
        required=False
    )

    args = parser.parse_args()
    convert_checkpoint(config_file=args.config_file,
