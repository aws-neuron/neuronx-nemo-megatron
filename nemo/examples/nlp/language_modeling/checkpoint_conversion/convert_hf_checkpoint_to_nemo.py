...
def convert_checkpoint(args):
    ...
    translation = {
        "model.language_model.embedding.word_embeddings.weight": (1, "model.embed_tokens.weight", 0, 0), # a['model']['language_model']['word_embeddings']['weight']
    ...
    for p in range(PP):
        for i in range(TP):
            ...
            #print(f"What are in sidde '{output_folder}/model_optim_rng.ckpt'???: {os.listdir(f'{output_folder}/model_optim_rng.ckpt')}")
