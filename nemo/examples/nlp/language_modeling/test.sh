...
torchrun $DISTRIBUTED_ARGS megatron_gpt_pretraining.py  \
    ...
    model.tokenizer.vocab_file=/shared/examples_datasets/gpt2/gpt2-vocab.json \
    model.tokenizer.merge_file=/shared/examples_datasets/gpt2/gpt2-merges.txt \
    model.data.data_prefix=[1.0,/shared/examples_datasets/gpt2/my-gpt2_text_document] \
